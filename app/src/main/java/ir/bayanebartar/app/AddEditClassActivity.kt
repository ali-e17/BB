...
class AddEditClassActivity : ir.bayanebartar.app.BaseActivity() {

    private var classId: String = ""
    private var existingClass: ir.bayanebartar.app.ClassModel? = null
    ...
    private val classNameOptions = mutableListOf<ir.bayanebartar.app.ClassNameOption>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (classId.isBlank()) {
            ...
            val defaults = _root_ide_package_.ir.bayanebartar.app.RemoteConfigManager.current().classDefaults
