...
class DictionaryActivity : BaseActivity() {
    ...
    // 🌟 لیست سیاه متداول کلمات نامناسب جهت مچ‌گیری نهایی در سطح لایه اپ
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRandomWord.setOnClickListener {
            ...
            databaseExecutor.execute {
                ...
                while (!foundSafeWord && attempts < 10 && !destroyed) {
                ...
                mainHandler.post {
                    ...
                    btnRandomWord.isEnabled = true

                    if (randomEntry != null && foundSafeWord) {
                        searchGeneration.incrementAndGet() // لغو سرچ‌های دی‌بایِنس قبلی
                        etSearch.text = null
        ...
        databaseExecutor.execute {
            ...
            mainHandler.post {
                ...
                result.onSuccess { helper ->
                    ...
                    btnRandomWord.isEnabled = true // 🌟 فعال شدن دکمه پس از لود کامل
